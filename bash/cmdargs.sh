...
vebosemode=0
debugmode=0
#For status of input variables are created
...
while [ $# -gt 0 ]; do
  ...
  -d )
    ...
    [1-5] )
		...
		debugmode=$2
		#For processing of new element, shifting is done over line of argument
		shift
		;;
    *)
...
#State of variable is recognised by conditional command
if [ $vebosemode = 1 ]; then
